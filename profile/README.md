...
<img src="https://github.com/Hardik-Sankhla/Hardik-Sankhla/blob/main/apps/web/public/assets/images/HardikSankhlaLinkedinProfileBackground.png" alt="Hardik Sankhla — AI/ML Banner" width="100%" />
...
This repository powers a multi-surface ecosystem:

- GitHub profile source in `profile/README.md`
- Portfolio source in `apps/web`
- Docs source in `apps/docs`
